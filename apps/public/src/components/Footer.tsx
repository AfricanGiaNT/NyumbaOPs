      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="space-y-2">
            <h3 className="text-lg font-semibold text-zinc-900">Madikwe Apartments</h3>
            <p className="text-sm text-zinc-600">
              Verified short-term apartments in Lilongwe, Malawi.
            </p>
            <div className="flex items-center gap-2">
              <a
                ...
                className="inline-flex min-h-[44px] items-center gap-2 rounded-full bg-[#FF8F35] px-4 py-2.5 text-sm font-semibold text-white transition-all hover:opacity-90 active:scale-95"
              >
        ...
        <div className="mt-8 pt-8 border-t border-zinc-200 text-center text-xs text-zinc-500">
          <p>&copy; {new Date().getFullYear()} Madikwe Apartments. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
