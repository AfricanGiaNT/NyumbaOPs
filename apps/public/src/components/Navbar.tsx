...
export function Navbar() {
  ...
  return (
    <nav
      className="sticky top-0 z-40 w-full border-b border-zinc-200 bg-white/95 backdrop-blur-sm"
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        >
          ...
          <span className="hidden sm:inline">Nyumba Stays</span>
        </Link>
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <a
            ...
            className="flex items-center gap-1.5 rounded-full bg-emerald-500 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-emerald-600 active:scale-95"
          >
