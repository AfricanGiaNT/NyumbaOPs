    ...
    <main className="bg-gradient-to-b from-white via-zinc-50 to-white">
      <section className="mx-auto max-w-7xl px-4 pb-16 pt-12">
        ...
        <header className="mb-12 space-y-6 text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-[var(--accent)]/10 px-4 py-2">
          ...
          <div className="space-y-4">
            ...
            <p className="mx-auto max-w-2xl text-lg text-zinc-600">
              Discover verified short-term apartments in Lilongwe with transparent pricing,
              modern amenities, and exceptional hospitality.
            </p>
          </div>
