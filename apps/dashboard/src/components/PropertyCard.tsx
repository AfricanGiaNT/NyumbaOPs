...
export function PropertyCard({ property, onEdit, onDelete }: PropertyCardProps) {
  ...
  return (
    <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
      {/* Cover Image */}
      {coverImage ? (
      ...
      <div className="p-5">
        ...
        <div className="mt-4 grid grid-cols-2 gap-y-1.5 text-sm text-zinc-600 dark:text-zinc-400">
        ...
        <div className="mt-5 flex items-center gap-2 flex-wrap">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-zinc-100 dark:bg-zinc-800 px-3 py-1.5 text-xs font-semibold text-zinc-700 dark:text-zinc-300 ring-1 ring-zinc-200 dark:ring-zinc-700 hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors"
          >
